...
class ProductFilterFeatureText():
    """
    Фильтр для текстовых характеристик товаров
    Args:
        feature: характеристика товара, для которой создается фильтр
    """
    def __init__(self, feature: Feature):
        self.feature = feature
        self.filter_obj = django_filters.CharFilter(method='filter_text')
        self.filter_obj.parent = self

    def filter_text(self, queryset: QuerySet, name: None, value: str):
        """
...
class ProductFilterFeatureCheckbox():
    """
    ...
    def __init__(self, feature: Feature):
        self.feature = feature
        self.filter_obj = django_filters.CharFilter(method='filter_checkbox')
        self.filter_obj.parent = self

    def filter_checkbox(self, queryset: QuerySet, name: None, value: str):
        """
...
class ProductFilterFeatureSelect():
    """
    ...
    def __init__(self, feature: Feature):
        ...
        self.filter_obj = django_filters.MultipleChoiceFilter(
            choices=value_choices, method='filter_select')
        self.filter_obj.parent = self

    def filter_select(self, queryset: QuerySet, name: None, value: List[str]):
        """
