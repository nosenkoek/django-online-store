...
FeatureInlineFormset = forms.inlineformset_factory(Product, Product.features.through, exclude=[])
...
class FeatureFormset(FeatureInlineFormset):
    ...
    def add_fields(self, form, index) -> None:
        ...
        if index is not None and form.instance.feature_fk.type_feature == 'checkbox':
