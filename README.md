...
# Веб-приложение интернет-магазин MEGANO.
...
Разворачивается в контейнере store_app. Состоит из 3х приложений:
...
- обработчики взаимодействия с источниками данных (загрузка и выгрузка).
  ...
  3 стратегии для get_data/load_data взаимодействия с pg/es/redis. 
